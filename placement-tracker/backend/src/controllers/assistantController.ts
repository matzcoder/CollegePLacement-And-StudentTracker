...
export async function assistantQuery(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function getAssistantHistory(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
